...
export interface NodeLaunchInterface extends utils.Interface {
  contractName: "NodeLaunch";
  functions: {
...
export interface NodeLaunch extends BaseContract {
  contractName: "NodeLaunch";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NodeLaunchInterface;
